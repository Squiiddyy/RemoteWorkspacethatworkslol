...
public class ModelOpossum<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition earL_r1 = head.addOrReplaceChild("earL_r1",
				CubeListBuilder.create().texOffs(32, 44).addBox(-1.0F, -3.0F, -1.0F, 3.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.5F, -1.5F, -2.0F, 0.0F, 0.0F, 0.3054F));

		PartDefinition earR_r1 = head.addOrReplaceChild("earR_r1",
				CubeListBuilder.create().texOffs(24, 44).addBox(-2.0F, -3.0F, -1.0F, 3.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.5F, -1.5F, -2.0F, 0.0F, 0.0F, -0.3054F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay,
		...
		opossum.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
