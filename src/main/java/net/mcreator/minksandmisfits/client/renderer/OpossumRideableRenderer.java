...
public class OpossumRideableRenderer extends MobRenderer<OpossumRideableEntity, ModelOpossum<OpossumRideableEntity>> {
	public OpossumRideableRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<OpossumRideableEntity, ModelOpossum<OpossumRideableEntity>>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.parse("minksandmisfits:textures/entities/opcollar.png");

			@Override
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, OpossumRideableEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	private static final class AnimatedModel extends ModelOpossum<OpossumRideableEntity> {
		private final ModelPart root;
		private final HierarchicalModel animator = new HierarchicalModel<OpossumRideableEntity>() {
			@Override
			...
			@Override
			public void setupAnim(OpossumRideableEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
