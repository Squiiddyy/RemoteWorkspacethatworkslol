...
public class ModelOpossum<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition opossum = partdefinition.addOrReplaceChild("opossum", CubeListBuilder.create(), PartPose.offset(-0.5F, 19.5F, 1.0F));
		PartDefinition tailop = opossum.addOrReplaceChild("tailop", CubeListBuilder.create(), PartPose.offset(0.5F, 0.0F, 4.0F));
		PartDefinition cube_r1 = tailop.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 16).addBox(-0.5F, -3.5F, 0.0F, 0.0F, 6.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2618F, 0.0F, 0.0F));
		PartDefinition backlegright = opossum.addOrReplaceChild("backlegright", CubeListBuilder.create().texOffs(44, 9).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, 2.0F, 3.0F));
		PartDefinition backlegleft = opossum.addOrReplaceChild("backlegleft", CubeListBuilder.create().texOffs(44, 4).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, 2.0F, 3.0F));
		PartDefinition bodyop = opossum.addOrReplaceChild("bodyop", CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -3.0F, -6.0F, 7.0F, 5.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(24, 16)
				.addBox(-3.0F, -4.5F, -6.0F, 0.0F, 6.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(0, 34).addBox(3.0F, -4.5F, -6.0F, 0.0F, 6.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition head = opossum.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(24, 34).addBox(-3.5F, -3.0F, -5.0F, 7.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(36, 0).addBox(-2.5F, 0.0F, -7.0F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition earR_r1 = head.addOrReplaceChild("earR_r1", CubeListBuilder.create().texOffs(24, 44).addBox(-2.0F, -3.0F, -1.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.5F, -1.5F, -2.0F, 0.0F, 0.0F, -0.3054F));
		PartDefinition frontlegleft = opossum.addOrReplaceChild("frontlegleft", CubeListBuilder.create().texOffs(36, 9).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, 2.0F, -4.0F));
		PartDefinition frontlegright = opossum.addOrReplaceChild("frontlegright", CubeListBuilder.create().texOffs(36, 4).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, 2.0F, -4.0F));
