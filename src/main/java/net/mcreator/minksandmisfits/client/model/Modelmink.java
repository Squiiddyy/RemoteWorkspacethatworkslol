...
public class Modelmink<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("minksandmisfits", "modelmink"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition MainHead = partdefinition.addOrReplaceChild("MainHead",
				CubeListBuilder.create().texOffs(18, 17).addBox(-2.5F, -2.0F, -4.0F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(36, 0).addBox(-1.5F, 0.0F, -5.0F, 3.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.5F, 13.0F, -5.0F));
		PartDefinition earL_r1 = MainHead.addOrReplaceChild("earL_r1", CubeListBuilder.create().texOffs(36, 6).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.5F, -1.0F, -1.0F, 0.0F, 0.0F, 0.4363F));
		PartDefinition earR_r1 = MainHead.addOrReplaceChild("earR_r1", CubeListBuilder.create().texOffs(36, 3).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, -1.0F, -1.0F, 0.0F, 0.0F, -0.4363F));
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -1.0F, -3.0F, 5.0F, 4.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offset(0.5F, 18.0F, -2.0F));
		PartDefinition cube_r1 = body.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(18, 26).addBox(-3.5F, -3.0F, -1.0F, 4.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.5F, -3.0F, -3.0F, 0.2618F, 0.0F, 0.0F));
		PartDefinition FrontLegR = partdefinition.addOrReplaceChild("FrontLegR", CubeListBuilder.create().texOffs(0, 31).addBox(-0.8F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 21.0F, -3.0F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int rgb) {
		MainHead.render(poseStack, vertexConsumer, packedLight, packedOverlay, rgb);
