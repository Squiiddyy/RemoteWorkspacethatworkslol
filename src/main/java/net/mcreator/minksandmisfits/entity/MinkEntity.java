...
public class MinkEntity extends TamableAnimal {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new FollowOwnerGoal(this, 1.25, (float) 8, (float) 2));
		...
		this.targetSelector.addGoal(9, new NearestAttackableTargetGoal(this, Chicken.class, true, true));
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(MinksandmisfitsModEntities.MINK.get(), SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
