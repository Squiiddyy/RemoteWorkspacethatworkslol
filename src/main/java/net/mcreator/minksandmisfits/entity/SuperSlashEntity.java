...
import net.mcreator.minksandmisfits.procedures.SuperSlashWhileProjectileFlyingTickProcedure;
...
public class SuperSlashEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(MinksandmisfitsModItems.SLASH.get());
	...
	public SuperSlashEntity(EntityType<? extends SuperSlashEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public SuperSlashEntity(EntityType<? extends SuperSlashEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	protected ItemStack getDefaultPickupItem() {
		return new ItemStack(MinksandmisfitsModItems.SLASH.get());
	}
	...
	public void tick() {
		...
		SuperSlashWhileProjectileFlyingTickProcedure.execute(this.level(), this);
		if (this.inGround)
			this.discard();
	}
	...
	public static SuperSlashEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 0.3f, 5, 5);
	}
	...
	public static SuperSlashEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		SuperSlashEntity entityarrow = new SuperSlashEntity(MinksandmisfitsModEntities.SUPER_SLASH.get(), entity, world, null);
	...
	public static SuperSlashEntity shoot(LivingEntity entity, LivingEntity target) {
		SuperSlashEntity entityarrow = new SuperSlashEntity(MinksandmisfitsModEntities.SUPER_SLASH.get(), entity, entity.level(), null);
