...
public class ABlock extends FlowerBlock implements SimpleWaterloggedBlock {
	...
	public boolean mayPlaceOn(BlockState groundState, BlockGetter worldIn, BlockPos pos) {
		return groundState.is(Blocks.WATER) || groundState.is(Blocks.BUBBLE_COLUMN) || groundState.is(Blocks.SAND);
	}
