...
public class CattailBlock extends DoublePlantBlock implements SimpleWaterloggedBlock {
	...
	public boolean mayPlaceOn(BlockState groundState, BlockGetter worldIn, BlockPos pos) {
		return groundState.is(MinksandmisfitsModBlocks.BLUE_SAND.get()) || groundState.is(Blocks.MUD) || groundState.is(Blocks.GRAVEL) || groundState.is(Blocks.SAND) || groundState.is(Blocks.CLAY);
	}
