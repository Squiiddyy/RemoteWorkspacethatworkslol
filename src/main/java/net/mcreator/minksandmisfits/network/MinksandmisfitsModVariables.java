...
public class MinksandmisfitsModVariables {
	...
	public static void init(FMLCommonSetupEvent event) {
		MinksandmisfitsMod.addNetworkMessage(SavedDataSyncMessage.TYPE, SavedDataSyncMessage.STREAM_CODEC, SavedDataSyncMessage::handleData);
	}
	...
	public static class MapVariables extends SavedData {
		public static final String DATA_NAME = "minksandmisfits_mapvars";
		boolean _syncDirty = false;
	...
	public record SavedDataSyncMessage(int dataType, SavedData data) implements CustomPacketPayload {
		public static final Type<SavedDataSyncMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(MinksandmisfitsMod.MODID, "saved_data_sync"));
