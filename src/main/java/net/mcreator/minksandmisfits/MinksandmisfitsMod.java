package net.mcreator.minksandmisfits;
...
@Mod("minksandmisfits")
public class MinksandmisfitsMod {
	public static final Logger LOGGER = LogManager.getLogger(MinksandmisfitsMod.class);
	public static final String MODID = "minksandmisfits";

	public MinksandmisfitsMod(IEventBus modEventBus) {
